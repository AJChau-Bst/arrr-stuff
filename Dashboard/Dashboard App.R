...
ui <- dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem("Correlation", icon = icon("cogs"),
               menuSubItem("2020", tabName = "infiniterecharge", icon = icon("battery-half")),
               menuSubItem("2019", tabName = "deepspace", icon = icon("rocket")),
               menuSubItem("2018", tabName = "powerup", icon = icon("cubes"))),
      textOutput("tab")
    )
  ),
